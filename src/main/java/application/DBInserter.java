...
public class DBInserter {
    ...
    private static void initCourses() {
        ...
        lftc.setLessonTemplates(Arrays.asList(
                ...
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)2).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)3).weight(0.0).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)4).weight(0.7).build(),
                ...
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)7).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)8).weight(0.0).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)9).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)10).weight(0.0).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)11).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)12).weight(0.0).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)13).weight(0.10).build(),
        ...
        retele.setLessonTemplates(Arrays.asList(
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)2).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)3).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)4).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)5).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)6).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)7).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)8).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)9).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)10).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)11).weight(0.7).build(),
                LessonTemplate.builder().type(LessonType.LABORATORY).nr((byte)12).weight(0.0).build(),
