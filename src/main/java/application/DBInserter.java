...
public class DBInserter {
    ...
    private static void initCourses() {
        ...
        lftc.setLessonTemplates(Arrays.asList(
                ...
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)2).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)3).weight(0.0).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)4).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)5).weight(0.0).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)6).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)7).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)8).weight(0.0).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)9).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)10).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)11).weight(0.07).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)12).weight(0.0).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)13).weight(0.09).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.LABORATORY).nr((byte)14).weight(0.0).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.PARTIAL_EXAM_SEMINAR).nr((byte)1).weight(0.14).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.PARTIAL_EXAM_COURSE).nr((byte)1).weight(0.14).build(),
                LessonTemplate.builder().course(lftc).type(LessonType.PARTIAL_EXAM_COURSE).nr((byte)2).weight(0.14).build()
        ));
        ...
        flct.setLessonTemplates(Arrays.asList(
                ...
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)2).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)3).weight(0.0).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)4).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)5).weight(0.0).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)6).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)7).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)8).weight(0.0).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)9).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)10).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)11).weight(0.07).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)12).weight(0.0).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)13).weight(0.09).build(),
                LessonTemplate.builder().course(flct).type(LessonType.LABORATORY).nr((byte)14).weight(0.0).build(),
                LessonTemplate.builder().course(flct).type(LessonType.PARTIAL_EXAM_SEMINAR).nr((byte)14).weight(0.14).build(),
                LessonTemplate.builder().course(flct).type(LessonType.PARTIAL_EXAM_COURSE).nr((byte)14).weight(0.14).build(),
                LessonTemplate.builder().course(flct).type(LessonType.PARTIAL_EXAM_COURSE).nr((byte)14).weight(0.14).build()
        ));
        ...
        pdm.setLessonTemplates(Arrays.asList(
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)2).weight(0.0).build(),
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)3).weight(0.0).build(),
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)4).weight(0.0).build(),
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)5).weight(0.0).build(),
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)6).weight(0.0).build(),
                LessonTemplate.builder().course(pdm).type(LessonType.LABORATORY).nr((byte)7).weight(1.0).build()
        ));
        ...
        mdp.setLessonTemplates(Arrays.asList(
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)2).weight(0.0).build(),
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)3).weight(0.0).build(),
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)4).weight(0.0).build(),
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)5).weight(0.0).build(),
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)6).weight(0.0).build(),
                LessonTemplate.builder().course(mdp).type(LessonType.LABORATORY).nr((byte)7).weight(1.0).build()
        ));
        ...
        pdav.setLessonTemplates(Arrays.asList(
                ...
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)2).weight(0.2).build(),
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)3).weight(0.2).build(),
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)4).weight(0.2).build(),
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)5).weight(0.2).build(),
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)6).weight(0.0).build(),
                LessonTemplate.builder().course(pdav).type(LessonType.LABORATORY).nr((byte)7).weight(0.2).build()
        ));
        ...
        ss.setLessonTemplates(Arrays.asList(
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)2).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)3).weight(0.2).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)4).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)5).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)6).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)7).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)8).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)9).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)10).weight(0.2).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)11).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)12).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)13).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.LABORATORY).nr((byte)14).weight(0.0).build(),
                LessonTemplate.builder().course(ss).type(LessonType.PARTIAL_EXAM_LABORATORY).nr((byte)1).weight(0.15).build(),
                LessonTemplate.builder().course(ss).type(LessonType.PARTIAL_EXAM_LABORATORY).nr((byte)2).weight(0.15).build(),
                LessonTemplate.builder().course(ss).type(LessonType.PARTIAL_EXAM_LABORATORY).nr((byte)3).weight(0.15).build(),
                LessonTemplate.builder().course(ss).type(LessonType.PARTIAL_EXAM_LABORATORY).nr((byte)4).weight(0.15).build()
        ));
        ...
        retele.setLessonTemplates(Arrays.asList(
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)1).weight(0.0).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)2).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)3).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)4).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)5).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)6).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)7).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)8).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)9).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)10).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)11).weight(0.07).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)12).weight(0.0).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)13).weight(0.15).build(),
                LessonTemplate.builder().course(retele).type(LessonType.LABORATORY).nr((byte)14).weight(0.15).build()
        ));
